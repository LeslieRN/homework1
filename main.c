...
int main()
{
    ...
    evaluation_main = insert_evaluction_values(&number_eval, binay_file2);
    //printf_evaluation(evaluation_main, number_eval);

    student_main = insert_student_values(&quantity_students, number_eval, binay_file, binay_file2);
